...
import { LanguagesIcon, Loader2Icon, Volume2Icon } from "lucide-react";
      ...
      <div className="max-w-[50%]">
        ...
        >
          ...
          <div className="flex gap-4 items-center">
            <div className="cursor-pointer flex gap-1 items-center bg-botMsg text-xs font-thin text-black p-[0.5]">
